                                    ...
                                    <table class="table text-center" style="font-size: 14px;padding: 20px;">
                                        ...
                                        <tbody style="font-size:16px;">
                                            ...
                                            <tr style="margin-top:10px;vertical-align:middle">
                                                ...
                                                ?>
                                                <td><a href="company_applicant_accept.php?job_id=<?php echo $job_id?>&user_id=<?php echo $user_id?>"
                                                        class="btn btn-success" style="font-weight:600">Select</a>
                                                    <a href="company_applicant_reject.php?id=<?php echo $user_id?>&job_id=<?php echo $job_id?>"
                                                        class="btn btn-danger" style="padding:7px 15px;margin-bottom:9px">Reject</a>
                                                </td>
                                            </tr>
                                            <?php 
                                                }
