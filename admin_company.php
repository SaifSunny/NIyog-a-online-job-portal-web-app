                ...
                <div class="col-md-10">
                    ...
                    <section class="team-details-area">
                        <div class="container" style="padding:2%;margin-top:2%;padding-left:2%">
                            <div class="row">
                                <div class="col-10">
                                    <h2 style="font-weight:600">Manage Companies</h2>
                                    <p><a href="admin_home.php">Home</a> /
                                        Manage Companies</p>
                                </div>
                                <div class="col-md-2" style="margin-top:20px;">
                                    <a href="admin_company_add.php" class="btn btn-success"><i class='fa fa-plus'></i> Add
                                    Company</a>
                                </div>
                            </div>
                                    ...
                                    <table class="table" style="font-size: 14px;padding: 20px;">
                                        ...
                                        ?>
                                            <tr style="margin-top:10px;vertical-align:middle">
                                                ...
                                                <td> <h5><?php echo $company_name?></h5> <p
                                                        class="text-success"
                                                        style="font-size:12px; font-weight:600;"><?php echo $category_name ?></p>
                                                </td>
                                                <td><?php echo $email ?></td>
                                                <td><?php echo $contact ?></td>
                                                <td><a href="<?php echo $website ?>">Visit Site</a></td>
                                                <td><?php echo $address ?></td>

                                                <td><a href="admin_company_delete.php?id=<?php echo $id?>"
