                ...
                <div class="col-md-2">
                    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
                        ...
                        <li class="nav-item">
                            ...
                            <li>
                                <a href="company_hire_history.php" class="nav-link active bg-success" aria-current="page"">
                                ...
                                <div class="col-md-12">
                                    <table class="table text-center" style="font-size: 14px;padding: 20px;">
                                        ...
                                        <tbody style="font-size:16px;">
                                            <?php 
                                            $sql = "SELECT * FROM jobs where company_id =$company_id and hired=1 order by job_id desc ";
                                            $result = mysqli_query($conn, $sql);
                                            if($result){
                                        ...
                                        ?>
                                            <tr style="margin-top:10px;vertical-align:middle">
                                                ...
                                                <td> <a href="company_applicant_details.php?user_id=<?php echo $user_id?>&job_id=<?php echo $id?>"><?php echo $user_name ?></a> </td>
                                                <td><button
