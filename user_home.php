                ...
                <div class="col-md-2">
                    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
                        ...
                        <ul class="nav nav-pills flex-column mb-auto">
                            <li class="nav-item">
                                <a href="user_home.php" class="nav-link active bg-success" aria-current="page">
                ...
                <div class="col-md-10">
                    ...
                    <section class="team-details-area">
                        <div class="container" style="padding:2%;margin-top:2%;padding-left:1%">
                            <div class="row">
                                <div class="col-12">
                                    <h2 style="font-weight:600">User Home</h2>
                                    <p>Home</p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card mx-auto"
                                        ...
                                        <h4 class="card-title">Job Appied</h4>
                                        <div class="card-body text-center">
                                            <?php
                                                $sql = "SELECT * from job_applicant where user_id =$user_id";
                                                $result = mysqli_query($conn, $sql);
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2);">
                                                ...
                                                <div class="card-body" style="padding:40px;">
                                                    <table class="table" style="font-size: 14px;padding: 20px;">
                                                        ...
                                                        <tbody style="font-size:16px;">
                                                            <?php 
                                                                $sql5 = "SELECT * FROM job_meeting where user_id =$user_id AND ustatus=0 and AND cstatus=0 order by job_id";
                                                ...
                                                ?>
                                                                ...
                                                                <td>
                                                                    <a href="user_meeting.php?meeting_id=<?php echo $meeting_id?>&link=<?php echo $meeting_link?>"
