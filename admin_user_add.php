                ...
                <div class="col-md-10">
                    ...
                    <section class="team-details-area">
                        <div class="container" style="padding:2%;margin-top:2%;padding-left:2%">
                            <div class="row">
                                <div class="col-10">
                                    <h2 style="font-weight:600">Add User</h2>
                                    <p><a href="admin_home.php">Home</a> / <a href="admin_users.php">Manage Users</a> /
                                        Add User</p>
                                </div>
                                                        ...
                                                        <div class="row" class="d-flex justify-content-between">
                                                            <div class="col-md-9">
                                                                <div class="form-group" style="padding:10px">
                                                                    <label style="padding-bottom:20px;">Profile
                                                                        Image</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label style="padding-bottom:20px;">First
                                                                            Name</label>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label style="padding-bottom:20px;">Last
                                                                            Name</label>
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label
                                                                            style="padding-bottom:20px;">Birthday</label>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label
                                                                            style="padding-bottom:20px;">Gender</label>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label
                                                                            style="padding-bottom:20px;">Email</label>
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label
                                                                            style="padding-bottom:20px;">Contact</label>
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label
                                                                            style="padding-bottom:20px;">Username</label>
                                                                        <input type="text" class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label
                                                                            style="padding-bottom:20px;">Password</label>
                                                                        <input type="text" class="form-control"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group" style="padding:10px">
                                                                        <label
                                                                            style="padding-bottom:20px;">Address</label>
                                                                        <input type="text" class="form-control"
