                ...
                <div class="col-md-2">
                    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
                        ...
                        <ul class="nav nav-pills flex-column mb-auto">
                            ...
                            <li>
                                <a href="user_applications.php" class="nav-link active bg-success" aria-current="page">
                            ...
                            <div class="row">
                                <table class="table" style="font-size: 14px;padding: 20px;">
                                    ...
                                    <tbody style="font-size:16px;">
                                        <?php 
                                            $sql5 = "SELECT * FROM job_applicant where user_id =$user_id";
                                        ...
                                        <tr style="margin-top:10px;vertical-align:middle">
                                            ...
                                            <td><a href="user_application_delete.php?job_id=<?php echo $job_id?>&user_id=<?php echo $user_id?>"
                                                    class="btn btn-danger" style="padding: 10% 20%;margin-bottom:10%">Cancel</a>
                                            </td>
