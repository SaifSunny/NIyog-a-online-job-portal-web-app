                        ...
                        <div class="container" style="padding:2%;margin-top:2%;padding-left:2%">
                            <div class="row">
                                <div class="col-10">
                                    ...
                                    <p><a href="admin_home.php">Home</a> / <a href="admin_category.php">Manage
                                    Categories</a> /
                                        Add Category</p>
                                </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group" style="padding:18px">
                                                                    <label style="padding-bottom:10px">Category Name</label>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group" style="padding:18px">
                                                                    <label  style="padding-bottom:10px">Category Description</label>
